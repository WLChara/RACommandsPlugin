...
enum class FramePacketMode : int
{
	FullNetworkEvents = 0,          // FrameInfo 0x6F + 完整 NetworkEvent 列表
	CompressedCommands = 1,         // FrameInfo 0x0E + 压缩 command 流
	FrameRateAlignedCompressed = 2  // 压缩 command 流，并且按 FrameSendRate 对齐发送
};
...
struct CellCopyFlags
{
	union
	{
		struct
		{
			...
			unsigned IsFogged : 1;
			unsigned Unknown_08000000 : 1;
			unsigned Unknown_10000000 : 1;
			unsigned Unknown_20000000 : 1;
			unsigned Unknown_40000000 : 1;
			unsigned Unknown_80000000 : 1;
		};
...
static_assert(sizeof(CellCopyFlags) == sizeof(DWORD), "CellCopyFlags must stay 4 bytes");


// Special rule flags, low WORD.
// Used by NetworkEvents::Special.
// bit numbering is zero-based.
typedef unsigned short eSpecialFlags;

#define sf_bit00                0x0001
#define sf_bit01                0x0002
#define sf_bit02                0x0004
#define sf_bit03                0x0008
#define sf_CTFMode              0x0010

// bit 5.
// TS-like name appears to be Inert.
// In RA2/YR testing, this behaves like global no-hurt / no damage.
#define sf_Inert                0x0020
#define sf_GlobalNoHurt         sf_Inert

#define sf_TiberiumGrows        0x0040
#define sf_TiberiumSpreads      0x0080
#define sf_MCVDeploy            0x0100
#define sf_InitialVeteran       0x0200
#define sf_FixedAlliance        0x0400
#define sf_HarvesterImmune      0x0800

// bit 12.
// TS-like name appears to be FogOfWar.
// In your test, this behaves like shroud/fog growth.
#define sf_FogOfWar             0x1000
#define sf_ShroudGrows          sf_FogOfWar

#define sf_bit13                0x2000
#define sf_TiberiumExplosive    0x4000
#define sf_DestroyableBridges   0x8000
