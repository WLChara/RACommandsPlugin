...
public:
	...
	// Set after the first native fire and cleared by the next attack-state cleanup;
	// this is the pending one-ammo consumption marker used by the double-bomb path.
	bool AmmoConsumePending;
